            ...
            <View style={styles.modalContent}>  
              ...
              <View style={styles.infoGroup}>
                <View style={styles.infoRow}>
                  <Ionicons name="pricetag-outline" size={20} color={COLORS.laranjaStock} style={styles.icon} />
                  <View>
                ...
                <View style={styles.infoRow}>
                  <Ionicons name="grid-outline" size={20} color={COLORS.laranjaStock} style={styles.icon} />
                  <View>
                ...
                <View style={styles.infoRow}>
                  <Ionicons name="barcode-outline" size={20} color={COLORS.laranjaStock} style={styles.icon} />
                  <View>
                ...
                <View style={styles.infoRow}>
                  <Ionicons name="cube-outline" size={20} color={COLORS.laranjaStock} style={styles.icon} />
                  <View>
